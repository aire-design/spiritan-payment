...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="text-spiritan mb-0">Add New Term</h3>
        ...
        <form method="POST" action="{{ route('terms.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" name="name" type="text" placeholder="e.g. First Term" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="form-check mt-2">
                        <input class="form-check-input" type="checkbox" name="is_locked" id="is_locked" value="1">
            ...
            <button class="btn btn-spiritan mt-4" type="submit">Save Term</button>
        </form>
    </div>
@endsection
