        ...
        <div class="card md-card border-0 p-0 overflow-hidden text-center">
            ...
            <div class="p-4 p-md-5 text-start">
                ...
                <div class="d-flex flex-column gap-3 mt-4">
                    @if($payment->status === 'success')
                        <a href="{{ route('pay.receipt.pdf', $payment) }}" download="receipt-{{ $payment->payment_reference }}.pdf" class="btn btn-lg btn-primary w-100 fw-medium shadow-sm rounded-pill d-flex justify-content-center align-items-center gap-2" style="background: var(--md-primary); border: none;">
