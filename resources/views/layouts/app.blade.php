...
<head>
    ...
    <style>
        ...
        .btn-md-primary {
            background: linear-gradient(135deg, #0b3d91 0%, #1a4da6 100%);
            color: #ffffff;
            border-radius: 100px;
            padding: 12px 28px;
            font-weight: 600;
        ...
        .btn-md-primary:hover {
            background: linear-gradient(135deg, #1a4da6 0%, #2b61cf 100%);
        ...
        .btn-success:hover {
            background: linear-gradient(135deg, #157347 0%, #1ba87e 100%);
