...
<div class="row mb-4 align-items-center">
    <div class="col">
        <h2 class="h3 text-spiritan">School Classes / Grades</h2>
    </div>
    <div class="col-auto">
        <a href="{{ route('classes.create') }}" class="btn btn-md-primary rounded-pill px-4 shadow-sm fw-medium transition-all">
                    ...
                    @forelse($classes as $class)
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <a href="{{ route('classes.edit', $class) }}" class="btn btn-sm btn-outline-primary rounded-pill px-3">Edit</a>
                                <form action="{{ route('classes.destroy', $class) }}" method="POST" class="d-inline-block" onsubmit="return confirm('Delete this class? This cannot be undone.');">
                                    @csrf
                                    @method('DELETE')
